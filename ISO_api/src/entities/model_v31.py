...
class DtKeyType(Enum):
    ...
    DT_ELEMENT_FULLPATH = "DT_ELEMENT_FULLPATH"
...
class DtAsset:
    ...
    endpoint: Optional[DtEndpoint] = field(
        default=None,
        metadata={
            "type": "Element",
        },
    )
    dt_elements: list[DtElement] = field(
        default_factory=list,
        metadata={
            "type": "Element",
        },
...
class DtProperty(DtElement):
    ...
    properties: list[KeyValue] = field(
        default_factory=list,
        metadata={
            "type": "Element",
            "namespace": "http://digital-thread.re/dt_asset",
...
class DtFile(DtElement):
    ...
    reference: list[DtReference] = field(
        default_factory=list,
        metadata={
            "type": "Element",
            "namespace": "http://digital-thread.re/dt_asset",
